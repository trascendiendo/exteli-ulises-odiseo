			...
			<div className="flex items-center relative md:min-h-screen">
				<div className="absolute bottom-0 left-0 right-0 top-0">
					...
					<div
						className="absolute bottom-0 left-0 right-0 top-0"
						style={{
							backgroundColor: "rgba(33, 37, 41, .85)",
				...
				<div
					className="flex flex-col-reverse h-full items-end w-full md:flex-row"
					style={{ zIndex: "5" }}
				>
					...
					<div className="flex flex-grow items-center justify-center w-full md:w-6/12">
						{/*
							<div
							className="bg-white flex items-center mx-3 my-8 w-full rounded-xl md:my-5"
							style={{ maxWidth: "480px", minHeight: "calc(100vh - 110px)" }}
						>
							<div className="flex flex-col justify-center p-6 w-full">
								...
								<h4 className="mb-4 text-xl" style={{ color: "1d2630" }}>
									Identificarse con correo electrónico
								</h4>
								<div className="mb-3">
									<InputText
										type="email"
